...
@author: dr.aarij
'''
from com.search.heuristic.misPlacedTilesEightPuzzleHeuristic import MisPlacedTilesEightPuzzleHeuristic
from com.search.node import Node
from com.search.eightPuzzleProblem import EightPuzzleProblem
from com.search.strategy.UniformCostSearchStrategy import UniformCostSearchStrategy
from com.search.strategy.breadthFirstSearchStrategy import BreadthFirstSearchStrategy
from com.search.strategy.depthFirstSearchStrategy import DepthFirstSearchStrategy
from com.search.strategy.greedySearch import GreedySearch
        ...
        while not self.searchStrategy.isEmpty():
            ...
            for nextState in nextMoves:
                if nextState.stringRep() not in duplicateMap:
                    newNode = Node(nextState, currentNode, currentNode.depth + 1, currentNode.cost + nextState.cost,
                                   nextState.action)
...
if __name__ == "__main__":
    ...
    searchStrategy = UniformCostSearchStrategy()
    ...
    if result is not None:
        ...
        print("Number of nodes explored: %d" % search.count)
